...
async function fetchData() {
    try {
        const response = await fetch("https://61c1f80d9dbcca0017c82272.mockapi.io/Users",)
        ...
        tableList.addEventListener('click', (e) => {
            ...
            if (deleteButtonIsPressed) {
                if (confirm('Are you sure to delete this record?')) {
                    fetch(`https://61c1f80d9dbcca0017c82272.mockapi.io/Users/${idValue}`, {
                        method: "DELETE",
                    })
                        .then(res => res.json())
...
postData.addEventListener('submit', async function (e) {
    ...
    if (isEdit == true) {
        try {
            await fetch(`https://61c1f80d9dbcca0017c82272.mockapi.io/Users/${idValues.value}`, {
                method: "PUT",
                headers: {
